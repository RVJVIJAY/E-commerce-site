...
function Cart() {
  ...
  const saveOrder = async () => {
    ...
    try {
      ...
      // Clear cart or redirect to another page if needed
    } catch (error) {
      console.log(error);
  ...
  return (
    <Layout>
      <div className="h-screen bg-gray-100 pt-5 overflow-auto" style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '' }}>
...
/* with Payment Gateway code using razorpay */
...
import { deleteFromCart } from '../../redux/cartSlice';
import { toast } from 'react-toastify';
import { addDoc,fireDB,collection } from 'firebase/firestore';
